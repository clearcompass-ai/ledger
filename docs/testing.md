...
| P2 | Pure v0.9.6 (zero tech debt) | `go.mod` pins SDK v0.9.6; compile-time interface checks at `gossipstore/commitment_fetcher.go:121`, `gossipnet/sequencer_adapter.go:103-105` | `gossipnet/equivocation_binding_pin_test.go::TestEquivocationBinding_OperatorMatchesSDK` (drift pin between operator code and SDK helper) |
